...
from unified_video_action.gym_util.video_recording_wrapper import VideoRecordingWrapper, VideoRecorder
...
from unified_video_action.env.robomimic.robomimic_image_wrapper import RobomimicImageWrapper
    ...
    def __init__(self, 
        ...
        with h5py.File(dataset_path, 'r') as f:
            for i in range(n_train):
                ...
                env_prefixs.append('train/%s_'%env_meta['bddl_file'].split('/')[-1][:-5])
    ...
    def run(self, policy: BaseImagePolicy, vis_pred_video=False, **kwargs):
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                # run policy
                with torch.no_grad():
                    action_dict = policy.predict_action(obs_dict, language_goal=[self.language_goal]*obs_dict['agentview_image'].size(0), **kwargs)
