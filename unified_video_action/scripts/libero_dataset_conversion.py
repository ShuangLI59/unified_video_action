...
@click.command()
@click.option('-i', '--input', default='/local/real/shuang/data/diffusion_policy/libero_goal/put_the_cream_cheese_in_the_bowl_demo.hdf5', help='input hdf5 path')
@click.option('-o', '--output', default='debug_convert_action2/put_the_cream_cheese_in_the_bowl_demo.hdf5', help='output hdf5 path. Parent directory must exist')
# @click.option('-o', '--output', default='/local/real/shuang/data/diffusion_policy/libero_goal_convert/put_the_cream_cheese_in_the_bowl_demo.hdf5', help='output hdf5 path. Parent directory must exist')
